...
${OBJECTDIR}/matrix_dynamic.o: matrix_dynamic.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/matrix_dynamic.o matrix_dynamic.c

${OBJECTDIR}/matrix_static.o: matrix_static.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/matrix_static.o matrix_static.c

${OBJECTDIR}/test_dynamic.o: test_dynamic.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test_dynamic.o test_dynamic.c

${OBJECTDIR}/test_static.o: test_static.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test_static.o test_static.c
